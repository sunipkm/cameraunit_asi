...
```toml
[dependencies]
cameraunit_asi = { git = "https://github.com/sunipkm/cameraunit_asi" }
```
...
For a more complete example, refer to the test program in [`asicam_rs`](https://github.com/sunipkm/asicam_rs).