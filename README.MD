...
For a more complete example, refer to the test program in the [image capture example](examples/imagecapture.rs).

The included example can be run with `cargo run --release --example imagecapture`.